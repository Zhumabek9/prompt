...
```mermaid
graph TD
    A[Cold Traffic Facebook/TikTok Ads] --> B[Landing Page: $6.99 Pack]
    A --> C[Lead Magnet: 5 Free Prompts Box]
    C --> D[Email Opt-in Confirmation]
    D --> E[OTO Page: One-Time-Offer $4.99 Deal]
    E -->|Purchased| F[Up-sell: VIP Commercial Pack $14.99]
    E -->|Declined| G[Day 1 Welcome Email with Free PDF]
    G --> H[Day 2 Case Study: How Emma Saved $2,000]
    H --> I[Day 3 Scarcity: 85% Discount Expires]
    I -->|Converted| F
```
